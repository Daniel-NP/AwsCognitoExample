...
namespace AwsCognitoExample.Helpers
{
    ...
    {
        public CognitoResultType Type { get; }
        ...
        public CognitoResult(CognitoResultType type, AuthFlowResponse response = null, CognitoUser user = null, ImmutableCredentials credentials = null)
        {
            Type = type;
            if (response != null)
            {
